...
namespace HMS.Data.Services.SMSModule
{
    public class MessagingService : IMessagingService
    {
        ...
        public async Task<PatientDTO> PatientInfo(PatientDTO patientDTO)
        {
            try
            {
                ...
                var txtMessage = "Dear  " + patientDTO.FirstName + " Welcome to Kapsara Hospital .Your Registration Code is :" + patientDTO.RegistrationCode + ". For any inquries please reach us through our Helpline No.:+254726961045";
                ...
                var msisdn = formatPhoneNumber(patientDTO.PhoneNumber);
